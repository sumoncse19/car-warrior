        ...
        <Box className="container add-product">
            <Box className="card my-5 py-5 shadow">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <input hidden {...register("name", { required: true, maxLength: 20 })} placeholder={user.displayName} defaultValue={user.displayName} /> <br />

                    <textarea {...register("review")} placeholder="Details" /> <br />

                    <input type="text" {...register("rating")} placeholder="Rating out of 5" /> <br />
